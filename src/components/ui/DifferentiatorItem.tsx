...
export function DifferentiatorItem({
  ...
  return (
    <motion.div
      ...
      className="flex gap-5 py-7 border-t border-[--color-border] first:border-t-0"
    >
      <div className="shrink-0 grid place-items-center h-10 w-10 rounded-lg bg-[--color-accent-soft] text-[--color-accent]">
